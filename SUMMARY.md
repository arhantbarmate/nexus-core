...
* **[ECONOMICS.md](./ECONOMICS.md)** — The 60/30/10 Deterministic Settlement Invariant.
...
* **[ROADMAP.md](./ROADMAP.md)** — Phased engineering and DePIN readiness.
...
* **[THREAT_MODEL.md](./THREAT_MODEL.md)** — Explicit threat surface and security assumptions.
* **[PRIVACY.md](./PRIVACY.md)** — Local-First persistence and Data Sovereignty policy.
...
* **[CONTRIBUTING.md](./CONTRIBUTING.md)** — PR standards and 1M Stress Test requirements.

---

### 🛰️ Interactive Portal
For the high-fidelity graphical interface of these specs, access the local reference surface:
