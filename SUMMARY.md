# 📑 Documentation Summary — Nexus Protocol (v1.3.1)
...
* **[ROADMAP.md](./ROADMAP.md)** — Phased engineering and DePIN readiness (Epochs I-III).
...
For the high-fidelity graphical interface of these specs, open:
`docs/portal/index.html`

---

© 2026 Nexus Protocol · Protocol Specification Suite v1.3.1
